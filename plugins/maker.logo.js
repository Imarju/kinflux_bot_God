let handler = async (m, { conn, args, text, usedPrefix, command }) => { 
         let tee = `Parth! Enter a short text\n\n📌 Example  : *${usedPrefix + command}* GMX` 
         let too = `Parth! Separate the text with a *+* \n\n📌 Example : \n*${usedPrefix + command}* HEY *+* PARTH` 
         ...
         switch (type) { 
           case 'gfx1': 
                 ...
                 conn.sendFile(m.chat, chut, 'logo.png', `Hey parth! complete ✼`, m); 
                 m.react(done); 
                 break; 
           ...
           case 'gfx2':  
                 ...
                 conn.sendFile(m.chat, loda, 'logo.png', `Hey parth! complete ✼`, m); 
           ...
           case 'gfx3': 
                 ...
                 conn.sendFile(m.chat, cp, 'logo.png', `Hey parth! complete ✼`, m); 
                 m.react(done); 
                 break; 
           ...
           case 'gfx4':  
                 ...
                 conn.sendFile(m.chat, gandu, 'logo.png', `Hey parth! complete ✼`, m); 
                 m.react(done); 
                 break; 
                 case 'gfx5': 
     if (!text) throw tee 
     const apiUrll = `https://api.lolhuman.xyz/api/textprome/jokerlogo?apikey=${lolkeysapi}&text=${encodeURIComponent(text)}`; 
     conn.sendFile(m.chat, apiUrll, 'logo.png', 'Hey parth! complete ✼', m); 
     m.react('✅'); 
     break; 
         ...
         conn.sendFile(m.chat, apiUrl, 'logo.png', `Hey parth! complete ✼`, m) 
         m.react(done) 
         break  
         case 'gfx7':  
         if (!text) throw too; 
         ...
         conn.sendFile(m.chat, oda, 'logo.png', `Hey parth! complete ✼`, m); 
         ...
         conn.sendFile(m.chat, od, 'logo.png', `Hey parth! complete ✼`, m); 
         ...
         conn.sendFile(m.chat, rr, 'logo.png', `Hey parth! complete ✼`, m); 
         m.react(done); 
         break; 
