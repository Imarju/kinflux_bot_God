...
// This function is used to prevent users from sending too many messages in a chat application or gmx bot.
...
export async function before(m) {
    ...
    // If anti-spam is disabled for this chat, or if the message is from the gmx bot itself,
    ...
    if (timeDifference < 10000) {
        ...
        if (this.spam[m.sender].count >= 5) {
            ...
            setTimeout(() => {
                ...
                m.reply(`⚠️ *Hey parth! Cooldown finished*\nYou can send messages again.`);
            }, 5000);
